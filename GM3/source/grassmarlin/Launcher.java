...
import grassmarlin.ui.console.CommandParser;
...
public class Launcher {
    ...
    public static void main(String[] args) {
        ...
        switch(configuration.getUiMode()) {
            ...
            case SDI:
                handlerFileLogging = initializeLoggingToFile();
                Logger.setInStartup(true);
                configuration.loadPlugins();
                configuration.loadPipelines();
                Logger.setInStartup(false);
                launchSdi();
                break;
            case DIAGNOSTIC:
                launchDiagnostic();
    ...
    private static void launchConsole() {
        final CommandParser parser = new CommandParser(Launcher.configuration);
        parser.executeLoop();
    }
