...
public class Ipv4WithPort extends Ipv4 implements IHasPort {
    ...
    public boolean contains(final LogicalAddress other) {
        if(super.contains(other)) {
            return this.port == ((Ipv4WithPort)other).port;
        } else {
            return false;
        }
    }
    ...
    @Override
    public Ipv4 getAddressWithoutPort() {
