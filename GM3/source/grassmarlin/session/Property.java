...
public class Property<T extends Serializable> implements XmlSerializable, Comparable<Property<?>> {
     ...
     */
    public Property(final T value, final Confidence confidence) {
        this.value = value;
    ...
    public Property(final XMLStreamReader source) throws XMLStreamException {
        this.confidence = Confidence.fromNumber(Integer.parseInt(source.getAttributeValue(null, "confidence")));
    ...
    public int compareTo(final Property<?> other) {
        ...
        if(valueMatch == 0) {
            return this.confidence.asNumber() - other.confidence.asNumber();
        } else {
            return valueMatch;
        }
    }
    ...
    public void writeToXml(final XMLStreamWriter target) throws XMLStreamException {
        target.writeAttribute("confidence", Integer.toString(this.confidence.asNumber()));
    ...
    public String toString() {
        return String.format("%s (%d - %s)", value, confidence.asNumber(), confidence.asString());
    }
}
