...
public class Loader {
    public static void loadSession(final Session session, final ZipFile zip) throws IOException, XMLStreamException {
    ...
    public static Object readObject(final XMLStreamReader reader) throws XMLStreamException {
        ...
        if(namePlugin == null) {
            ...
            switch(nameClass) {
                ...
                default:
                    if(nameClass.startsWith("java.lang.")) {
                        try {
                            if(Number.class.isAssignableFrom(Class.forName(nameClass))) {
                                return Class.forName(nameClass).getConstructor(String.class).newInstance(reader.getElementText());
                            }
