...
public class EthernetIpv4Packet implements ILogicalPacketData, ILogicalPacketMetadata {
    ...
    protected final LogicalAddressMapping addrSource;
    protected final LogicalAddressMapping addrDestination;
    ...
    public EthernetIpv4Packet(
            ...
            final long idxFrame,
            final long msTime,
            final LogicalAddressMapping addrSource,
            final LogicalAddressMapping addrDestination,
            final long size,
