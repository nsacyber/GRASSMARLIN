...
public class UdpPacket extends PacketDataWrapper implements IUdpPacketData, IUdpPacketMetadata {
    ...
    public UdpPacket(final ILogicalPacketData packet, final int idxUdpHeaderStart, final LogicalAddressMapping addrSource, final LogicalAddressMapping addrDestination) {
        super(packet);
