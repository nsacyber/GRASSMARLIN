...
public class LivePcapImport extends ImportItem {
    ...
    private final Map<Session.HardwareAddressPair, Session.HardwareAddressPair> addressPairs;
    ...
    protected final void reportHardwareLink(final HardwareAddress src, final HardwareAddress dest, final BlockingQueue<Object> packetQueue) {
        ...
        final Session.HardwareAddressPair existing = addressPairs.get(pair);
        if(existing == null) {
    ...
    protected final void reportPacket(final ILogicalPacketMetadata packet, final BlockingQueue<Object> packetQueue) {
        reportHardwareLink(packet.getSourceAddress().getHardwareAddress(), packet.getDestAddress().getHardwareAddress(), packetQueue);
        try {
