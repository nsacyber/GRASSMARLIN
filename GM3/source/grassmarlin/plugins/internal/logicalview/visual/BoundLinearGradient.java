...
public class BoundLinearGradient extends ObjectBinding<Paint> {
    ...
    public Paint computeValue() {
        ...
        return new LinearGradient(x1.doubleValue(), y1.doubleValue(), x2.doubleValue(), y2.doubleValue(), false, CycleMethod.NO_CYCLE, new Stop(0.0, c1.get()), new Stop(1.0, c2.get()));
    }
}
