...
public class NetworkDialog extends Dialog {
    ...
    protected class TableItem {
        ...
        public TableItem(final String source, final LogicalAddress network, final Confidence confidence) {
            this.source = source;
        ...
        public boolean isEditable() {
            //Ideally we would like this to be reference equality, but when dealing with loading a session from disk, we would lose that.
            return this.source.equals(SOURCE_USER);
        }
    }
    ...
    private void initComponents() {
        ...
        final TableColumn<TableItem, Confidence> colConfidence = new TableColumn<>("Confidence");
        ...
        networkEntry.onActionProperty().set(event -> {
            ...
            networkEntry.clear();
            NetworkDialog.this.networks.addNetwork(SOURCE_USER, new Network(address, Confidence.USER));
        });
