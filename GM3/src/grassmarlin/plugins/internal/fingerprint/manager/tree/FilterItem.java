package grassmarlin.plugins.internal.fingerprint.manager.tree;


import core.fingerprint3.ObjectFactory;
import grassmarlin.plugins.internal.fingerprint.manager.FingerPrintGui;
import grassmarlin.plugins.internal.fingerprint.manager.editorPanes.FilterRow;
...
public class FilterItem extends TreeItem<String>{
    ...
    public FilterItem(Filter.FilterType type, int index, FingerPrintGui gui, JAXBElement value) {
        ...
        this.row = FilterRow.newFilterRow(this, value);
    }
