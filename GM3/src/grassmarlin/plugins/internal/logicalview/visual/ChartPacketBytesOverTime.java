...
public class ChartPacketBytesOverTime extends Chart<GraphLogicalEdge.PacketList.PacketMetadata, Long, Long> {
    ...
    @Override
    protected Long calculateXFor(final GraphLogicalEdge.PacketList.PacketMetadata value) {
        return value.getTime();
    }
    protected Long calculateYFor(final GraphLogicalEdge.PacketList.PacketMetadata value) {
