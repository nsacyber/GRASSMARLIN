        ...
        this.setOnContextMenuRequested(event -> {
            ...
            if(records.isEmpty()) {
                ...
                for(final T record : records) {
                    if(record instanceof GraphLogicalEdge.PacketList.PacketMetadata) {
                        final GraphLogicalEdge.PacketList.PacketMetadata packet = (GraphLogicalEdge.PacketList.PacketMetadata)record;
