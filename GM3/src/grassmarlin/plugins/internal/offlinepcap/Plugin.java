...
public class Plugin implements IPlugin, IPlugin.HasImportProcessors {
    private enum PersistedValues implements RuntimeConfiguration.IPersistedValue {
        ...
        private PersistedValues(final String key, final RuntimeConfiguration.IDefaultValue fnDefault) {
            this.key = key;
        ...
        return Arrays.asList(
                new ImportProcessorWrapper(
                    ...
                    public boolean itemIsValidTarget(final ImportItem item) {
                        return PcapImport.validateFileFormat(item.getPath());
                    }
                },
                new ImportProcessorWrapper("PcapNg", ".pcapng") {
                    ...
                    @Override
                    public boolean itemIsValidTarget(final ImportItem item) {
                        return PcapNgImport.validateFileFormat(item.getPath());
                    }
                }
        );
    }
