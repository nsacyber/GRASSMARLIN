...
public class AsyncTaskQueue {
    ...
    private final Thread threadTasks;
    ...
    public AsyncTaskQueue(final Event.IAsyncExecutionProvider uiProvider) {
        ...
        this.threadTasks = new Thread(this::Thread_processQueue);
        this.threadTasks.setName("AsyncTaskQueue");
        this.threadTasks.setDaemon(true);
        this.threadTasks.start();
    }
