...
public class LogicalEdgeReportDialogFx extends Dialog {
    ...
    private void initComponents() {
        ...
        colBytesSent.setCellValueFactory(cellData -> new SimpleStringProperty(cellData.getValue().getDetailsToDestination().getCntBytes().toString()));

        TableColumn<LogicalEdge, String> colBytesRecv = new TableColumn<>("Bytes Received");
        colBytesRecv.setCellValueFactory(cellData -> new SimpleStringProperty(cellData.getValue().getDetailsToSource().getCntBytes().toString()));
