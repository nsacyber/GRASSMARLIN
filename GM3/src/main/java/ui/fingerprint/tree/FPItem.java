...
public class FPItem extends TreeItem<String> {
    ...
    public FPItem(FingerprintState fpState) {
        ...
        this.pathProperty = new SimpleObjectProperty<Path>(fpState.getPathProperty());
        ...
        this.dirtyProperty = new SimpleBooleanProperty(fpState.getDirtyProperty());
        this.enabledProperty = new SimpleBooleanProperty(fpState.getEnabledProperty());
