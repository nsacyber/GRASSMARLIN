...
public class LogicalNode implements INode<LogicalNode>, ObservableValue<LogicalNode> {
    ...
    public LogicalNode(final Cidr ip, final byte[] mac, final List<Cidr> networks) {
    ...
    public HashMap<String, Set<ComputedProperty>> getAnnotations() {
        return this.annotations;
    }

    public HashMap<Object, HashMap<String, Set<ComputedProperty>>> getFingerprintPayloadResults() {
        return this.fingerprintPayloadResults;
    }
