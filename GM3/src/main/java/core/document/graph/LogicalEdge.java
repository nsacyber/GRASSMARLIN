...
public class LogicalEdge extends AbstractBidirectionalEdge<LogicalNode> {
    public static class ConnectionDetails {
        ...
        public void setCntBytes(Long bytes) {
          this.cntBytes = bytes;
        }
    ...
    public LogicalEdge(LogicalNode source, LogicalNode destination) {
        ...
        detailsEdge = new String();
        if(source == null || destination == null) {
            detailsEdge = "Source or Destination was null";
        } else {
            detailsEdge = "details are commented out below";
            /*
            detailsEdge.bind(
    ...
    public String getEdgeDetailsProperty() {
        return detailsEdge;
    }
    public void setEdgeDetailsProperty(String edgeDetails) {
      this.detailsEdge = edgeDetails;
    }
    ...
    public XmlElement toXml(List<LogicalNode> nodes, List<ImportItem> items, ZipOutputStream zos) throws IOException {
        ...
        xmlDetailsTo.addAttribute("bytes").setValue(Long.toString(getDetailsToDestination().getCntBytes()));
        ...
        xmlDetailsFrom.addAttribute("bytes").setValue(Long.toString(getDetailsToSource().getCntBytes()));
