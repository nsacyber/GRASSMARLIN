...
import core.document.graph.MeshGraph;
    ...
    public void setSavePath(Path pathSave) {
        ...
        if(pathSave == null) {
            ...
            if (Platform.isFxApplicationThread()) {
                currentSessionName = pathSave.toAbsolutePath().toString();
            } else {
                Platform.runLater(() -> currentSessionName = pathSave.toAbsolutePath().toString());
            }
        }
    }

    private String currentSessionName;
    public String getCurrentSessionNameProperty() {
        return currentSessionName;
    }
    void setCurrentSessionNameProperty(String name) {
