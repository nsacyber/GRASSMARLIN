...
import iadgov.fingerprint.processor.FProcessor;
...
public class StageFingerprint extends AbstractStage<Session> {
    ...
    public StageFingerprint(RuntimeConfiguration config, Session session) {
        ...
        defineOutput(FINGERPRINT_PROPERTIES, FingerprintVertexProperties.class, FingerprintEdgeProperties.class);
        disallowOutputClasses(StageFingerprint.DEFAULT_OUTPUT, FingerprintVertexProperties.class, FingerprintEdgeProperties.class);
    ...
    public Object process(Object obj) {
        if (processor != null) {
            return processor.process((ILogicalPacketMetadata) obj);
        } else {
            return null;
        }
    }
