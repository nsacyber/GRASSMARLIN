...
import grassmarlin.ui.common.controls.UnselectingComboBox;
import iadgov.fingerprint.manager.payload.Category;
import iadgov.fingerprint.manager.payload.Role;
...
public class DetailsDialog extends Dialog<DetailsDialog> {
    ...
    public DetailsDialog(Category category, Role role, Map<String, String> details) {
        ...
        ComboBox<Category> catBox = new UnselectingComboBox<>(FXCollections.observableArrayList(Category.values()), Category.NONE);
        if (this.category != null) {
            catBox.setValue(this.category);
        }
        catBox.setTooltip(new Tooltip("The Category of Device"));
        Label roleLabel = new Label("Role:");
        ComboBox<Role> roleBox = new UnselectingComboBox<>(FXCollections.observableArrayList(Role.values()), Role.NONE);
        if (this.role != null) {
            roleBox.setValue(this.role);
        }
        roleBox.setTooltip(new Tooltip("The SCADA role of this device"));
        ...
        addButton.setTooltip(new Tooltip("Add new property"));
    ...
    private class DetailRow extends HBox {
        ...
        public DetailRow(VBox parent, String name, String value) {
            ...
            Tooltip.install(nameText, nameTip);
            ...
            Tooltip valueTip = new Tooltip("The value of the property");
            Tooltip.install(valueLabel, valueTip);
            ...
            removeButton.setTooltip(new Tooltip("Remove property"));
