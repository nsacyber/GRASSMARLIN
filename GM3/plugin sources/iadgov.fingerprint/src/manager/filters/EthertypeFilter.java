...
public class EthertypeFilter implements Filter<Integer> {
    ...
    public HBox getInput() {
        ...
        Tooltip etherTip = new Tooltip("The value contained in the ethertype position of the Ethernet header(0x0800 = IPv4)");
        Tooltip.install(typeLabel, etherTip);
        Tooltip.install(typeField, etherTip);
