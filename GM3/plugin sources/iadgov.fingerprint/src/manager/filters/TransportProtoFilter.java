...
public class TransportProtoFilter implements Filter<Short> {
    ...
    public HBox getInput() {
        ...
        Tooltip protoTip = new Tooltip("The transport protocol of the packet");
        Tooltip.install(protoLabel, protoTip);
        Tooltip.install(protoBox, protoTip);
