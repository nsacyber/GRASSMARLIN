...
public class Plugin implements grassmarlin.plugins.IPlugin, grassmarlin.plugins.IPlugin.HasVersionInfo {
    public final static String NAME = "Team Colors";
    ...
    public Plugin(final RuntimeConfiguration config) {
        ...
        gm.addGroupColorFactory(NAME, () -> new GenerateColors());
    }

    private class GenerateColors implements ILogicalViewApi.ICalculateColorsForAggregate {
