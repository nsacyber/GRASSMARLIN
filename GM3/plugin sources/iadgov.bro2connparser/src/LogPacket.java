...
public class LogPacket implements IAddress, IPacketMetadata{
    ...
    private final Session.AddressPair addressPair;
    ...
    protected LogPacket(final Long time,
        ...
        this.addressPair = new Session.AddressPair((IAddress)srcAddrMap, (IAddress)dstAddrMap);
    ...
    Session.AddressPair getAddressPair() { return addressPair; }
    ...
    @Override
    public IAddress getSourceAddress() { return srcAddrMap; }
    @Override
    public IAddress getDestAddress() { return dstAddrMap; }
    @Override
