...
public class VisualPipelineEntry extends HBox implements IDraggable {
    ...
    public VisualPipelineEntry(final String title) {
        ...
        textTitle.setFill(VisualPipeline.VISUAL_ELEMENT_TITLE_TEXT_FILL);
        ...
        this.setBackground(new Background(new BackgroundFill(VisualPipeline.VISUAL_ELEMENT_TITLE_FILL, VisualPipeline.VISUAL_ELEMENT_CORNER_RADII, null)));
