...
public class RadialTreeLayout extends TreeLayout {
     ...
     */
    protected double calcAngularWidth(NodeItem n, int d) {
    ...
    protected static final double normalize(double angle) {
    ...
    protected Iterator sortedChildren(final NodeItem n) {
        double base = 0;
